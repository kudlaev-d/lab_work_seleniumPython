...
class AddReviewTest(unittest.TestCase):
    ...
    def test_add_review(self):
        ...
        self.assertEqual(self.product_page.get_alert_text(), self.expected_rating_alert)
        ...
        self.assertEqual(self.product_page.get_alert_text(), self.expected_unsuccessful_review_alert)
        ...
        self.assertEqual(self.product_page.get_alert_text(), self.expected_successful_review_alert)
